...
const advt = async () => {
    ...
    await page.click('ul.el-menu>div.menu-wrapper>li.el-submenu:last-child',{waitUntil: 'load'})
    await page.click('ul.el-menu>div.menu-wrapper>li.el-submenu:last-child>ul.el-menu>a:last-child>li',{waitUntil: 'load'})
}
advt()