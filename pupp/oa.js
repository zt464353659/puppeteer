...
const oa = async () => {
    const options = {
     ...
     await page.goto('http://oa.suntekcorps.com/login/Login.jsp?gopage=/hrm/resource/HrmResourcePassword.jsp?isfromtab=false&_token_=f5ce0de3-bbf8-43f5-b2b2-c9920a194a4d',{waitUntil: 'load'})
